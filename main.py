...
def handle_404(request, response, exception):
    ...
    response.write("""<h1>Oops! I could swear this page was here!</h1><br><h2>
                    <a href="/blog">Better Get back to safty</a></h2>""")
    response.set_status(404)


def handle_500(request, response, exception):
    logging.exception(exception)
    response.write("""<h1>Its our bad. I promiss it will not happen again ;)</h1><br>
                    <h2><a href="/blog">Better Get back to safty</a></h2>""")
